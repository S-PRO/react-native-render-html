...
export function img(htmlAttribs, children, convertedCSSStyles, passProps = {}) {
  ...
  return (
    <HTMLImage source={{ uri: src }} alt={alt} width={width} height={height} style={style} {...passProps} />
  );
}
...
export function iframe(htmlAttribs, children, convertedCSSStyles, passProps) {
  ...
  return <WebView key={passProps.key} source={{ uri: htmlAttribs.src }} style={style} />;
}
